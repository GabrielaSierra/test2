...
module.exports = async (ctx, next) => {
  ...
  //extra line of code written by me to modify strapis usual permission
//if u make a req to strapi while using a valid magic bearer token, strapi will make authenticated req with magic
